# The IOI City Mall Data Generator is a Laravel package that simplifies the creation of daily sales data files for IOI City Mall stores. It seamlessly integrates into Laravel projects, streamlining data generation for retail management.
...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/ioi-city-mall-sales-file.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/ioi-city-mall-sales-file)
...
```bash
php artisan vendor:publish --tag="ioi-city-mall-sales-file-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="ioi-city-mall-sales-file-views"
```

## Usage

```php
$ioiCityMallSalesFile = new RetailCosmos\IoiCityMallSalesFile();
echo $ioiCityMallSalesFile->echoPhrase('Hello, RetailCosmos!');
```
